                ...
                constructor() {
                    ...
                    // Bridge
                    {
                        ...
                        for (let i = 0; i < N; ++i) {
                            ...
                            const anchor = new b2.b2Vec2(160.0 + 2.0 * i, -0.125);
                            jd.Initialize(prevBody, body, anchor);
                            this.m_world.CreateJoint(jd);
                            prevBody = body;
                        }
                        const anchor = new b2.b2Vec2(160.0 + 2.0 * N, -0.125);
                    ...
                    // Car
                    {
                        const chassis = new b2.b2PolygonShape();
                        const vertices = b2.b2Vec2.MakeArray(8);
