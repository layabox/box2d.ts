...
System.register(["@box2d", "@testbed"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            PolygonShapesCallback = class PolygonShapesCallback extends b2.b2QueryCallback {
                constructor() {
                    super(...arguments);
                    this.m_circle = new b2.b2CircleShape();
                    this.m_transform = new b2.b2Transform();
                    this.m_count = 0;
                }
            ...
            PolygonShapes = class PolygonShapes extends testbed.Test {
                constructor() {
                    super();
                    this.m_bodyIndex = 0;
                    this.m_bodies = b2.b2MakeArray(PolygonShapes.e_maxBodies, () => null);
                    this.m_polygons = b2.b2MakeArray(4, () => new b2.b2PolygonShape());
                    this.m_circle = new b2.b2CircleShape();
                    // Ground body
                    {
