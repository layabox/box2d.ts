        ...
        execute: function () {
            DynamicTreeTest = class DynamicTreeTest extends testbed.Test {
                constructor() {
                    ...
                    this.m_queryAABB = new b2.b2AABB();
                    this.m_rayCastInput = new b2.b2RayCastInput();
                    this.m_rayCastOutput = new b2.b2RayCastOutput();
                    this.m_rayActor = null;
                    this.m_actors = b2.b2MakeArray(DynamicTreeTest.e_actorCount, () => new DynamicTreeTest_Actor());
                    this.m_stepCount = 0;
