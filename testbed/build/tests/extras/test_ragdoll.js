            ...
            TestRagdoll = class TestRagdoll extends testbed.Test {
                constructor() {
                    ...
                    for (let i = 0; i < 2; ++i) {
                        ...
                        // Head
                        fd.shape = new b2.b2CircleShape(1.25);
                        fd.density = 1.0;
                        fd.friction = 0.4;
                        fd.restitution = 0.3;
                        ...
                        //if (i === 0)
                        //{
                        head.ApplyLinearImpulse(new b2.b2Vec2(Math.random() * 1000.0 - 500.0, Math.random() * 1000.0 - 500.0), head.GetWorldCenter());
                        //}
                        // Torso1
                        ...
                        jd.enableLimit = true;
                        // Head to shoulders
                        jd.lowerAngle = b2.b2DegToRad(-40.0);
                        jd.upperAngle = b2.b2DegToRad(40.0);
                        jd.Initialize(torso1, head, new b2.b2Vec2(startX, (startY - 1.5)));
                        this.m_world.CreateJoint(jd);
                        // Upper arm to shoulders
                        // L
                        jd.lowerAngle = b2.b2DegToRad(-85.0);
                        jd.upperAngle = b2.b2DegToRad(130.0);
                        jd.Initialize(torso1, upperArmL, new b2.b2Vec2((startX - 1.8), (startY - 2.0)));
                        this.m_world.CreateJoint(jd);
                        // R
                        jd.lowerAngle = b2.b2DegToRad(-130.0);
                        jd.upperAngle = b2.b2DegToRad(85.0);
                        jd.Initialize(torso1, upperArmR, new b2.b2Vec2((startX + 1.8), (startY - 2.0)));
                        this.m_world.CreateJoint(jd);
                        // Lower arm to upper arm
                        // L
                        jd.lowerAngle = b2.b2DegToRad(-130.0);
                        jd.upperAngle = b2.b2DegToRad(10.0);
                        jd.Initialize(upperArmL, lowerArmL, new b2.b2Vec2((startX - 4.5), (startY - 2.0)));
                        this.m_world.CreateJoint(jd);
                        // R
                        jd.lowerAngle = b2.b2DegToRad(-10.0);
                        jd.upperAngle = b2.b2DegToRad(130.0);
                        jd.Initialize(upperArmR, lowerArmR, new b2.b2Vec2((startX + 4.5), (startY - 2.0)));
                        this.m_world.CreateJoint(jd);
                        // Shoulders/stomach
                        jd.lowerAngle = b2.b2DegToRad(-15.0);
                        jd.upperAngle = b2.b2DegToRad(15.0);
                        jd.Initialize(torso1, torso2, new b2.b2Vec2(startX, (startY - 3.5)));
                        this.m_world.CreateJoint(jd);
                        // Stomach/hips
                        jd.Initialize(torso2, torso3, new b2.b2Vec2(startX, (startY - 5.0)));
                        this.m_world.CreateJoint(jd);
                        // Torso to upper leg
                        // L
                        jd.lowerAngle = b2.b2DegToRad(-25.0);
                        jd.upperAngle = b2.b2DegToRad(45.0);
                        jd.Initialize(torso3, upperLegL, new b2.b2Vec2((startX - 0.8), (startY - 7.2)));
                        this.m_world.CreateJoint(jd);
                        // R
                        jd.lowerAngle = b2.b2DegToRad(-45.0);
                        jd.upperAngle = b2.b2DegToRad(25.0);
                        jd.Initialize(torso3, upperLegR, new b2.b2Vec2((startX + 0.8), (startY - 7.2)));
                        this.m_world.CreateJoint(jd);
                        // Upper leg to lower leg
                        // L
                        jd.lowerAngle = b2.b2DegToRad(-25.0);
                        jd.upperAngle = b2.b2DegToRad(115.0);
                        jd.Initialize(upperLegL, lowerLegL, new b2.b2Vec2((startX - 0.8), (startY - 10.5)));
                        this.m_world.CreateJoint(jd);
                        // R
                        jd.lowerAngle = b2.b2DegToRad(-115.0);
                        jd.upperAngle = b2.b2DegToRad(25.0);
                        jd.Initialize(upperLegR, lowerLegR, new b2.b2Vec2((startX + 0.8), (startY - 10.5)));
                        this.m_world.CreateJoint(jd);
                    }
