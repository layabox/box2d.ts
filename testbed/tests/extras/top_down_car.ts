...
export class TDTire {
  ...
  public getLateralVelocity(): b2.b2Vec2 {
  ...
  public getForwardVelocity(): b2.b2Vec2 {
...
export class TDCar {
  ...
  public m_body: b2.b2Body;
  public flJoint: b2.b2RevoluteJoint;
  public frJoint: b2.b2RevoluteJoint;
...
export class TopdownCar extends testbed.Test {
  ...
  public static handleContact(contact: b2.b2Contact, began: boolean): void {
  ...
  public static tire_vs_groundArea(tireFixture: b2.b2Fixture, groundAreaFixture: b2.b2Fixture, began: boolean): void {
